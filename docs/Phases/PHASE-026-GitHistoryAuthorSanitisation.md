...
ACCEPTANCE CRITERIA:
- All 34 commits show author and committer as a neutral identity (`<USERNAME>` <person@example.com>); zero commits reference person@example.com or "<PERSON>" afterward.
